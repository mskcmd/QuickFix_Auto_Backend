    ...
    fetchuserGrowths(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new Error(error.message || 'An error fetchuserGrowths');
            }
        });
    }
    fetchMechData(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.mechanicRepo.fetchMechData(id);
                return result;
            }
            catch (error) {
                throw new Error(error.message || "An Erorr in fetchMechData");
            }
        });
    }
}
